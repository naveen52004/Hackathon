            ...
            <div className="mt-4 sm:mt-0 sm:ml-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full sm:w-80 pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                />
                {searchTerm && (
                  <button
                    onClick={() => {
