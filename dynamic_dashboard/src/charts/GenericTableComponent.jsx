...
const GenericTableComponent = ({ 
  ...
  if (!apiResponse?.data?.agentIdtoFieldToFieldValueMap) {
    return (
      <div className="w-full max-w-full p-8 bg-white rounded-xl shadow-lg border border-gray-200">
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">Please check your data source and try again.</p>
        </div>
      </div>
    );
  }
...
const baseRows = useMemo(() => {
  ...
  return (
    <div className="w-full max-w-full bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      {/* Header Section */}
      <div className={`bg-gradient-to-r ${currentTheme.gradient} px-6 py-8`}>
            ...
            <div className="mt-4 sm:mt-0 sm:ml-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full sm:w-80 pl-10 pr-4 py-2 bg-white border text-black border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                />
                {searchTerm && (
                  <button
                    onClick={() => {
              ...
              {headers.map((header, index) => (
                <th
                  ...
                  className={`
                    ...
                    ${index === 0 ? 'min-w-[200px]' : 'min-w-[120px]'}
            ...
            {paginatedRows.map((row, index) => (
              ...
              >
                {headers.map((header, cellIndex) => {
                  const field = allFields.find(f => f.displayName === header);
                  ...
                  return (
                    <td
                      ...
                      className={`
                        ${compact ? 'px-4 py-3' : 'px-6 py-4'}
                        text-sm whitespace-nowrap border-r border-gray-100 last:border-r-0
                        ${cellIndex === 0 
                    ...
                    >
                      <div className={`
                        ...
                        ${field?.type === 'currency' || field?.type === 'number' ? 'font-mono text-right' : ''}
                        ${field?.type === 'percentage' ? 'font-medium text-center' : ''}
                      `}>
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-700">
              ...
              <span className="font-medium">{Math.min(currentPage * pageSize, sortedRows.length)}</span> of{' '}
